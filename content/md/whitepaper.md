...
For discussions, [join our developer chat](https://discord.gg/cosmosnetwork)!
...
zones. The zones are powered by Tendermint BFT [\[8\]][8], which provides a
...
system on top of ABCI, Tendermint BFT would be responsible for
...
The Cosmos Hub is the first public blockchain in the Cosmos Network, powered by the
...
Tendermint BFT also includes many optimizations and features that go above and
