  ...
  .projects-container: .projects
    ...
    .project.project-hub
      .project-header
        ...
        a.project-link(:href="urls.explorer" target="_blank" rel="noreferrer noopener")
          img.project-logo(
    ...
    .project.project-sdk
      .project-header
        ...
        a.project-link(:href="urls.gh.cosmosSdk" target="_blank" rel="noreferrer noopener")
          img.project-logo(
    ...
    .project.project-tmc
      .project-header
        ...
        a.project-link(:href="urls.gh.tendermint" target="_blank" rel="noreferrer noopener")
          img.project-logo(
            src="~images/roadmap/tendermint-core.png"
            alt="Tendermint BFT" @load="imageLoaded")
        .project-progress
          .project-progress__outer
    ...
    .project.project-gui
      .project-header
        .project-title Lunie
        a.project-link(:href="https://lunie.io" target="_blank" rel="noreferrer noopener")
          img.project-logo(
            src="~images/roadmap/lunie.png"
            alt="Lunie" @load="imageLoaded")
        .project-progress
          .project-progress__outer
...
.dependency-arrow
  ...
  &.da-tmc-hub
    background linear-gradient(to left, var(--tendermint) 33%, hub 67%)
  &.da-tmc-gui
    background linear-gradient(to left, var(--tendermint) 33%, gui 67%)
...
.projects
  ...
  border-bottom 0.25rem solid var(--app-fg)
